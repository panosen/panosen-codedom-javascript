...
namespace Panosen.CodeDom.JavaScript
{
    ...
    public static class CallMethodExpressionExtension
    {
        ...
        /// 添加参数
        /// </summary>
        public static TCallMethodExpression AddParameter<TCallMethodExpression>(this TCallMethodExpression callMethodExpression, string parameter) where TCallMethodExpression : CallMethodExpression
        {
            return AddParameter(callMethodExpression, (DataValue)parameter);
        }
        ...
        /// 添加 DataObject 类型的参数
        /// </summary>
        public static DataObject AddParameterOfDataObject<TCallMethodExpression>(this TCallMethodExpression callMethodExpression) where TCallMethodExpression : CallMethodExpression
        {
            return AddParameter<DataObject>(callMethodExpression);
        }

        /// <summary>
        /// 添加 SortedDataObject 类型的参数
        /// </summary>
        public static SortedDataObject AddParameterOfSortedDataObject<TCallMethodExpression>(this TCallMethodExpression callMethodExpression) where TCallMethodExpression : CallMethodExpression
        {
            return AddParameter<SortedDataObject>(callMethodExpression);
        }

        /// <summary>
        /// 添加 DataArray 类型的参数
        /// </summary>
        public static DataArray AddParameterOfDataArray<TCallMethodExpression>(this TCallMethodExpression callMethodExpression) where TCallMethodExpression : CallMethodExpression
        {
            return AddParameter<DataArray>(callMethodExpression);
        }

        /// <summary>
        /// 添加 CodeMethod 类型的参数
        /// </summary>
        public static CodeMethod AddParameterOfCodeMethod<TCallMethodExpression>(this TCallMethodExpression callMethodExpression) where TCallMethodExpression : CallMethodExpression
        {
            return AddParameter<CodeMethod>(callMethodExpression);
        }
    }
}
